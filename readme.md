# YOLOv11 leak detection system

## Body

YOLOv11 Leak Detection System, based on deep learning YOLOv11, is a device leak detection system (YOLOv11+YOLO dataset + UI interface + login and registration interface + Python project source code + model).
...
✅ Dual Screen Comparison: Display the original scene and detection results on the same screen.
